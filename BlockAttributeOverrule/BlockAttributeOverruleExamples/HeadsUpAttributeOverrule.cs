...
namespace AcMgdLib.DatabaseServices.Examples
{
   ...
   internal class HeadsUpAttributeOverrule : BlockAttributeOverrule
   {
      ...
      /// whose name contains the string 'BUBBLE', having an
      /// Attribute with the tag 'ID':
      /// </summary>
      ...
      /// <summary>
      /// The reusability baked into the base types allow the 
      /// operation to be implemented with 2 lines of code:
      /// </summary>

      protected override void Update(Transaction tr, AttributeReference att, BlockReference owner)
      {
         if(att.Rotation != 0.0)
            att.Rotation = 0.0;
      }
